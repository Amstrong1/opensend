...
<!--Footer container-->
<footer class="bg-secondary-100 text-center">
            ...
            <div class="gird-cols-1 grid items-center justify-center gap-4 md:grid-cols-3">
                ...
                <div class="relative md:mb-6" data-te-input-wrapper-init>
                    ...
                    <label for="exampleFormControlInput1"
                        class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-secondary-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none">Email
                    </label>
                </div>
